...
public class ManaelectrumPickaxeItem extends PickaxeItem implements CustomDamageItem, SortableTool {

    private static final int MANA_PER_DAMAGE = 45;

    public ManaelectrumPickaxeItem(Tier tier, int thing1, float thing2, Item.Properties properties) {
    ...
    public <T extends LivingEntity> int damageItem(ItemStack stack, int amount, T entity, Consumer<T> onBroken) {
        int manaPer = ((ManaelectrumPickaxeItem) stack.getItem()).getManaPerDamage();
