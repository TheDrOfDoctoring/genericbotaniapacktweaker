...
public class ManaelectrumHoeItem extends HoeItem implements CustomDamageItem, SortableTool {

    private static final int MANA_PER_DAMAGE = 75;

    public ManaelectrumHoeItem(Tier tier, int thing1, float thing2, Item.Properties properties) {
    ...
    public <T extends LivingEntity> int damageItem(ItemStack stack, int amount, T entity, Consumer<T> onBroken) {
            int manaPer = ((ManaelectrumHoeItem) stack.getItem()).getManaPerDamage();
