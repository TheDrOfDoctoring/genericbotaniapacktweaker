...
public class ItemTagProvider extends ItemTagsProvider{
    ...
    protected void addTags() {
        ...
        tag(BotaniaTags.Items.SPECIAL_FLOWERS).add(ItemRegistry.DIESELOTUS_ITEM.get());
        tag(BotaniaTags.Items.SPECIAL_FLOATING_FLOWERS).add(ItemRegistry.SPINERETTE_FLOATING_ITEM.get());
        tag(BotaniaTags.Items.SPECIAL_FLOATING_FLOWERS).add(ItemRegistry.DIESELOTUS_FLOATING_ITEM.get());
    }
